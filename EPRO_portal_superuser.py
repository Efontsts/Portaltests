...
#       driver.find_element_by_xpath("//portal-login/div/ng-component/div/div/div[2]/div/form/div[3]/div/button").click() #works
        driver.find_element_by_css_selector("portal-login > div > ng-component > div > div > div.widget.login-window > div > form > div:nth-child(3) > div > button.btn.btn-default.btn-lg").click()  #works
        time.sleep(5.0)
...
#       time.sleep(2.5)        
        ...
        time.sleep(0.5)
#       driver.find_element_by_xpath("//form[@class='form-horizontal submit ng-untouched ng-pristine ng-valid']/div[2]/button").click() #old
        driver.find_element_by_xpath("//body/my-app/ng-component/div/div[2]/div/portal-tabs/ng-component/div/div/div/div[3]/div/section/form/div[2]/button").click() #works
#       driver.find_element_by_css_selector("body > my-app > ng-component > div > div:nth-child(2) > div > portal-tabs > ng-component > div > div > div > div:nth-child(4) > div > section > form > div.col-xs-4.text-right > button").click() #works
        time.sleep(1.5)
        ...
        time.sleep(1.5)
        driver.find_element_by_xpath("//body/my-app/ng-component/div/div[2]/div/portal-tabs/ng-component/div/div/div[2]/div/portal-table/section/ng-table/table/tbody/tr/td[5]/a[1]/span").click() #works      
        time.sleep(1.5)
...
#       driver.find_element_by_xpath("//login-form/div/div/div[2]/div/form/div[3]/div/button").click() #works   
        ...
        time.sleep(2.5)
        driver.quit()
#       driver.find_element_by_xpath("//contact-access/div/div/password/section/form/div/div[2]/a/span").click() #don't work password section
#       time.sleep(2.5)
#       driver.find_element_by_link_text("Cancel").click()
#       time.sleep(1.5)
